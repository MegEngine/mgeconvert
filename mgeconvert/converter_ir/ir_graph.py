...
class IRGraph:
    ...
    def update_inputs_qparams(
        ...
        if input_data_type is not None:
            for i in range(len(self.graph_inputs)):
                # if self.graph_inputs[i].qparams is None:
                #     self.graph_inputs[i].qparams = create_qparams()
                ...
                #     )
                self.graph_inputs[i].q_dtype = input_data_type
        ...
        if input_scales is not None:
            ...
            for i in range(len(self.graph_inputs)):
                ...
                self.graph_inputs[i].scale = float(scale)
        if input_zero_points is not None:
            ...
            for i in range(len(self.graph_inputs)):
                ...
                self.graph_inputs[i].zero_point = int(zero_point)
